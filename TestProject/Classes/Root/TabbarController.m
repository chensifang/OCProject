...
- (void)viewDidLoad {
    ...
    BaseColletionViewController *UIVC = [[vc_class[0] alloc] init];
    ...
    BaseColletionViewController *dataVC = [[vc_class[1] alloc] init];
    ...
    BaseColletionViewController *threadVC = [[vc_class[2] alloc] init];
    ...
    BaseColletionViewController *libVC = [[vc_class[3] alloc] init];
    ...
    BaseColletionViewController *algorithmVC = [[vc_class[4] alloc] init];
